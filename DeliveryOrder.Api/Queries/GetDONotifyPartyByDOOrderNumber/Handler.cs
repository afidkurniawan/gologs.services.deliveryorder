...
namespace GoLogs.Services.DeliveryOrder.Api.Queries.GetDONotifyPartyByDOOrderNumber
{
    ...
    public class Handler : IRequestHandler<Request, Response>
    {
        ...
        /// <summary>
        /// Handle to get an DONotifyParty with the specified Id.
        /// </summary>
        ...
        public async Task<Response> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var notifyParties = await _context.DONotifyParties.FirstOrDefaultAsync(new Query().Where(nameof(DONotifyParty.DOOrderNumber), request.DOOrderNumber), cancellationToken);
            return notifyParties == null ? null : new Response { Id = notifyParties.Id, DOOrderNumber = notifyParties.DOOrderNumber, NotifyAddress = notifyParties.NotifyAddress.Split(';').ToList() };
        }
    }
}
